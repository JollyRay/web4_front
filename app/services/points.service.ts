...
export class PointsService {
  ...
  //   return this.http.get(AppComponent.API_URL+'/api/v1/points/get/amount',{ headers: { 'Content-Type': 'application/x-www-form-urlencoded',
  //       'Authorization': 'Basic ' +  localStorage.getItem('userHash')}});
  // }
  //
  // public getPointsAmountR(r: number){
  //   return this.http.get(AppComponent.API_URL+'/api/v1/points/get/amount/'+r,{ headers: { 'Content-Type': 'application/x-www-form-urlencoded',
  //       'Authorization': 'Basic ' +  localStorage.getItem('userHash')}});
  // }
  // public getPointsHit(){
  //   return this.http.get(AppComponent.API_URL+'/api/v1/points/get/hit',{ headers: { 'Content-Type': 'application/x-www-form-urlencoded',
  //       'Authorization': 'Basic ' +  localStorage.getItem('userHash')}});
  // }
  //
  // public getPointsHitR(r: number){
  //   return this.http.get(AppComponent.API_URL+'/api/v1/points/get/hit/'+r,{ headers: { 'Content-Type': 'application/x-www-form-urlencoded',
  //       'Authorization': 'Basic ' +  localStorage.getItem('userHash')}});
  // }
  //
